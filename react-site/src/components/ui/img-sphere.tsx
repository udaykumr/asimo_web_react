      ...
      >
        ...
        >
          <div className="relative" style={{ aspectRatio: '1' }}>
            ...
            <button
              onClick={() => setSelectedImage(null)}
              className="absolute top-3 right-3 w-10 h-10 bg-black bg-opacity-50 rounded-full text-white flex items-center justify-center hover:bg-opacity-70 transition-all cursor-pointer shadow-lg"
            >
              <X size={20} />
            </button>
          </div>
          ...
          {(selectedImage.title || selectedImage.description) && (
            <div className="p-6">
              {selectedImage.title && (
                <h3 className="text-2xl font-bold mb-2 text-gray-900">{selectedImage.title}</h3>
              )}
              {selectedImage.description && (
                <p className="text-base text-gray-600">{selectedImage.description}</p>
              )}
            </div>
          )}
        </div>
